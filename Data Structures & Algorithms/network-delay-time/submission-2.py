...
from typing import List
 ...
 # O(E log V): We evaluate at most E edges, and each Min-Heap push/pop operation takes log(V) time.
...
class Solution:
    def networkDelayTime(self, times: List[List[int]], n: int, k: int) -> int:
        ...
        for ui, vi, ti in times:  # Build Adjacency List: Map source -> (transit_time, destination)
